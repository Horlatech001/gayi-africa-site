    		...
    		if(isset($_POST['send_btn'])){
               ...
               $failedEmails=[];
			   	...
			   	foreach ($splitReceivers as $receiver) {
                    ...
                    <p><b>Phone Num:</b> '.$phone_number.'</p>
                    <p><b>Sex:</b> '.$sex.'</p>
                    <p><b>DOB:</b> '.$dob.'</p>
                    <p><b>Interest:</b> '.$interest.'</p>
                    <p><b>Motivation:</b> '.$motivation.'</p>
                    <p><b>Expectation:</b> '.$expectation.'</p>
...
<body>
   ...
   <div class="container-fluid membership_section">
      <div class="row">
         <div class="others">
            <h1 class="text-light banner-text other_taital">MEMBERSHIP</h1>
         </div>
      </div>
   </div>
   <!-- banner section end -->
   ...
   <div class="container">
      <div class="row">
         ...
         <div class="col-lg-6 apply-right mb-5">
            <h1 class="mt-5 text-center">MEMBERSHIP FORM</h1>
            <h4 class="text-center mb-3">Join us, let’s build a better Africa together.</h4>
            <div class="">
               <form method="POST" id="mail-form" enctype="multipart/form-data">
                  <div class="slide" id="slide1">
                     ...
                     <div class="form-group">
                        <input type="number" placeholder="Phone Number" class="form-control" name="phone_number">
                     </div>
                     <div class="form-group">
                        <input type="text" placeholder="Sex" class="form-control" name="sex">
                     </div>
                     <div class="form-group">
                  ...
                  <div class="slide" id="slide2">
                     <div class="form-group">
                        <label for="interest">Area of interest in GAYI (Entrepreneurship, Climate Actions, Sustainable Living)</label>
                        <input type="text" placeholder="" class="form-control" name="interest">
                     </div>
                     <div class="form-group">
                        <textarea rows="5" placeholder="Motivation" class="form-control" name="motivation"></textarea>
                     </div>
                     <div class="form-group">
                        <input type="text" placeholder="Your Expectation" class="form-control" name="expectation">
                     </div>
                     <div class="form-group">
                        <input type="text" placeholder="Highest Qualification" class="form-control"
                           name="qualification">
                     </div>
                     <div class="form-group">
                        <label for="certificate">Upload Documents (resume, profile or CV)</label>
                        <input type="file" class="form-control" name="certificate">
                     </div>
                     <div class="form-group">
                        <label for="interest">Role interested in (Graphics & Media designer, Executive Director, Project Manager, Financial MAnager, Community Manager, Publicity Manager, Welfare Manager, Business Strategist)</label>
                        <input type="text" placeholder="Type the role you are intereted in" class="form-control"
                           name="role">
                     </div>
